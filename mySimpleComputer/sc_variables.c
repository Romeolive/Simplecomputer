...
static int is_valid_address(int address) {
...
static int is_valid_flag_mask(int mask) {
  int all;
...
void printAccumulator(void) { printf("+%04X", reg_accumulator & 0x7FFF); }

void printCounters(void) { printf("%02d", reg_icounter); }
